...
plt.suptitle("Intentional homicide rate in EU",fontsize=24,fontweight="bold")
plt.title("Offenses per 100 000 inhabitants",y=0.89)
...
plt.figtext(0.99, 0.01, 'Source: Eurostat', horizontalalignment='right',fontsize=12)
#plt.legend(frameon=False,bbox_to_anchor=(1.00, 1),mode='expand',loc=1,borderaxespad=0.)
fig.tight_layout(pad=2.55)
#plt.show()
plt.savefig("crim_off_cat_intentional_homicide_total.svg")
