...
dataset_code = "hlth_rs_bds"
query = dataset_code + "?sinceTimePeriod=1970&precision=1&geo=DE&geo=ES&geo=FR&geo=IT&unit=P_HTHAB&facility=HBEDT_CUR"
# Read the data
...
plt.suptitle("Curative beds in EU countries hit by COVID-19",fontsize=24,fontweight="bold")
plt.title("Beds per 100 000 inhabitants",y=0.90)
...
#plt.show()
plt.savefig("hlth_rs_bds_curative.svg")
